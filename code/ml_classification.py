...
classifiers_available = ["naivebayes", "adaboost", "randomforest", "svm", "decisiontree", "multilayerperceptron", "dummyrandom", "extratree", "logisticregression"]
